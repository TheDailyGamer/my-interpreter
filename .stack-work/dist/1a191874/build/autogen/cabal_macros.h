...
/* package my-interpreter-0.1.0.0 */
#ifndef VERSION_my_interpreter
#define VERSION_my_interpreter "0.1.0.0"
#endif /* VERSION_my_interpreter */
#ifndef MIN_VERSION_my_interpreter
#define MIN_VERSION_my_interpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_interpreter */
...
#define CURRENT_PACKAGE_KEY "my-interpreter-0.1.0.0-F7fYAaFw4rNDruacdQbZrX"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "my-interpreter-0.1.0.0-F7fYAaFw4rNDruacdQbZrX"
